...
class OnlineTest extends JFrame implements ActionListener {
	...
	void set() {
		...
		if (current == 0) {
			label.setText("Que1: Who develope java");
			radioButton[0].setText("guido van Rossm");
			radioButton[1].setText("james Gosling");
			radioButton[2].setText("Dennis Ritchie");
			radioButton[3].setText("Bjare Stroustrup");
		}
		if (current == 1) {
			label.setText("Que2:  Which companent is used to compile, debug and execute the java program?");
		...
		if (current == 4) {
			label.setText("Que5:  which one of the following is not a java feature");
			radioButton[0].setText(" object-oriented");
			radioButton[1].setText("user of pointers");
		...
		if (current == 8) {
			label.setText("Que9: which 0f the following is not an OOPS concept in java?.");
			radioButton[0].setText("polymorphism");
			radioButton[1].setText("inheritance");
			radioButton[2].setText("Complicaion");
			radioButton[3].setText("Encapsulation");
		}
		if (current == 9) {
			label.setText("Que10: what expection is thrown when java is out of memory ");
			radioButton[0].setText("Memory Error");
			radioButton[1].setText("out of memoryError");
			radioButton[2].setText("Memory Out of Bounds Expection");
			radioButton[3].setText("Memory Full Exception");
		}
		label.setBounds(30, 40, 450, 20);
